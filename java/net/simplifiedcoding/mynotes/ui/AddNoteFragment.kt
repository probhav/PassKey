...
import net.simplifiedcoding.mynotes.db.AESEncryption.encrypt
...
class AddNoteFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            edit_text_title.setText(note?.title?.let { it1 -> decrypt(it1) })
            edit_text_note.setText(note?.note?.let { it1 -> decrypt(it1) })
        }
        ...
        button_save.setOnClickListener { view ->
            ...
            launch {
                ...
                context?.let {
                    ...
                    val mNote = encrypt(noteTitle)?.let { it1 -> encrypt(noteBody)?.let { it2 ->
                        Note(it1,
                            it2
                        )
                    } }
